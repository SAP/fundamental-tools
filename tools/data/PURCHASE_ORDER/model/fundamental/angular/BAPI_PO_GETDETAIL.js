...
BAPI_PO_GETDETAIL = {
  ...
  ACCOUNT_ASSIGNMENT: '',                  // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Account Assignment Data
  CONFIRMATIONS: '',                       // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Confirmations
  EXTENSIONS: '',                          // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Customer's Own Fields
  HEADER_TEXTS: '',                        // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Header Texts
  HISTORY: '',                             // CHAR(1)    BAPIMMPARA SELECTION           Also Provide PO History
  ITEMS: '',                               // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Item Data
  ITEM_TEXTS: '',                          // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Item Texts
  PURCHASEORDER: '',                       // CHAR(10)   BAPIEKKO PO_NUMBER             Purchase Order Number
  SCHEDULES: '',                           // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Schedule Lines
  SERVICES: '',                            // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Services and Limits
  SERVICE_TEXTS: '',                       // CHAR(1)    BAPIMMPARA SELECTION           Also Provide Service Texts
