//
// BAPI_EQUI_CREATE_BY_REFERENCE 0.2
//
...
BAPI_EQUI_CREATE_BY_REFERENCE = {
  ...
  EXTENSIONOUT: []                         // BAPIPAREX : ?de: Bezugsstruktur für BAPI-Parameter ExtensionIn / ExtensionOut
};
...
// prettier-ignore
COPY_FLAGS = {
  CP_DOCUMT                     : '',  // Checkbox: Copy document assignments
  CP_INSTLOC                    : '',  // Checkbox: Copy installation location
  CP_INTNOTE                    : '',  // Checkbox: Copy internal note
  CP_LONGTXT                    : '',  // Checkbox: Copy long text in logon language
  CP_MEASPT                     : '',  // Checkbox: Copy measuring points and counters
  CP_MPT_DOC                    : '',  // Checkbox: Copy measuring points with document allocations
  CP_MPT_TXT                    : '',  // Checkbox: Copy measuring points with long text
  CP_PARTNER                    : ''   // Checkbox: Copy partner allocation
};
