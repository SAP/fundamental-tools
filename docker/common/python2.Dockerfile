...
ARG pyenv_versions="2.7.17"
# 3.12.0 3.11.6 3.10.13 3.9.18 3.8.18"
...
RUN \
    ...
    sudo apt-get update && curl https://bootstrap.pypa.io/pip/2.7/get-pip.py --output get-pip.py && sudo python get-pip.py && \
