//
// BAPI_PO_CHANGE exception: 0  struct: 8  table: 41  var: 10
//
...
// POCONFIRMATION         :           [], // BAPIEKES Transfer Structure: Display/List - Vendor Confirmation
...
// POHISTORY              :           [], // BAPIEKBE Transfer Structure for PO History
// POHISTORY_MA           :           [], // BAPIEKBE_MA Transfer Structure for Purchase Order History Account Assignment Level
// POHISTORY_TOTALS       :           [], // BAPIEKBES Transfer Structure for PO History: Totals
...
const result = await client.call("BAPI_PO_CHANGE", parameters);
