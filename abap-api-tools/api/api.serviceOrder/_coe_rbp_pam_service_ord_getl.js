...
// BAPI_ALM_LIST_NAVIGATION_IN  

// prettier-ignore
const IS_DISPLAY_PARAMETERS = {
...
// prettier-ignore
const IT_SORTORDER_line = {
  NAME                             :   "", // SSTR (255) NAme of component by which to sort
  DESCENDING                       :   "", // CHAR (1) Sort Direction: 'X' (Descend.) or '  ' (Ascending (Default))
  ASTEXT                           :   "", // CHAR (1) Sorting: 'X' (AS TEXT) or ' ' (Not AS TEXT (Default))
};
...
// BAPI_ALM_ORDER_LISTHEAD_RANGES  
const ET_TEMPLATE = [];

// prettier-ignore
const ET_TEMPLATE_line = {
...
// /COE/RBP_S_PAM_ORDER_LIST_TTLS  
const ET_TOTALS = [];

// prettier-ignore
const ET_TOTALS_line = {
  USER_STATUS                      :   "", // CHAR (4) Individual status of an object (short form)
  TOTAL                            :    0, // INT4 (10) Total Number
};
...
// BAPI_ALM_LIST_NAVIGATION_RET  

// prettier-ignore
const ES_NAVIGATION_DATA = {
