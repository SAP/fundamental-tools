//
// BAPI_EQUI_CHANGE exception: 0  struct: 10  table: 2  var: 3
//
// abap 2.2.0 at: 2021-03-24 15:30:18
//
...
EQUIPMENT            :           "", // CHAR (18) ALPHA=ALPHA Number of Equipment to be Changed SU3=EQN
...
const result = await client.call("BAPI_EQUI_CHANGE", parameters);
...
// BAPI_ITOBX  Flag Structure for BAPI_ITOB for Fields to be Copied
...
// BAPI_ITOB_EQ_ONLYX  Flag Structure for BAPI_ITOB_EQ_ONLY for Fields to be Copied

// prettier-ignore
const DATA_SPECIFICX= {
...
// BAPI_FLEETX  Flag Structure Belonging to BAPI_FLEET (for Change BAPIs)
