//
// BAPI_EQUI_GETDETAIL exception: 0  struct: 4  table: 1  var: 1
//
...
EQUIPMENT            :           "", // CHAR (18) ALPHA=ALPHA Number of Equipment to be Read SU3=EQN
...
const result = await client.call("BAPI_EQUI_GETDETAIL", parameters);
