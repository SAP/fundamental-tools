//
// BAPI_EQUI_INSTALL exception: 0  struct: 4  table: 0  var: 1
//
...
EQUIPMENT            :           "", // CHAR (18) ALPHA=ALPHA Number of Equipment to be Installed SU3=EQN
...
const result = await client.call("BAPI_EQUI_INSTALL", parameters);

//
// IMPORT PARAMETERS
//

// BAPI_ITOB_EQ_INSTALL_EXT  Installation Date for Equipment
