...
// SUPEQUI           :           "", // CHAR (18) ALPHA=ALPHA Number of Previous Installation Location (Superior Equipment) SU3=EQN
...
const result = await client.call("BAPI_EQUI_DISMANTLE", parameters);
