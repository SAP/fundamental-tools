...
HTML or JS Views comprise of web components, grouped together into frontend layout elements and here is our Equipment app View [client/src/plm/equipment/view.html](../abap-api-tools/web-application-code-explorer/client/src/plm/equipment/view.html)
