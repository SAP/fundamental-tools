//
// BAPI_ALM_NOTIF_DATA_ADD var: 3  struct: 5  table: 10  exception: 0
//
...
// NOTFULLTXT                 :           [], // BAPI2080_NOTFULLTXTI Notif. long text
...
const result = await client.call("BAPI_ALM_NOTIF_DATA_ADD", parameters);
