//
// BAPI_PROCORD_COMPLETE_TECH var: 3  struct: 1  table: 3  exception: 0
//
...
// SCOPE_COMPL_TECH   :          '1', // CHAR (1) Complete technically: Order network explosion
...
const result = await client.call("BAPI_PROCORD_COMPLETE_TECH", parameters);
