//
// BAPI_PROCORD_GET_DETAIL var: 2  struct: 2  table: 7  exception: 0
//
...
ORDER_OBJECTS       :           {}, // BAPI_PI_ORDER_OBJECTS Selection Structure for Process Order Objects
...
// PHASE            :           [], // BAPI_ORDER_PHASE Phase Data
...
const result = await client.call("BAPI_PROCORD_GET_DETAIL", parameters);
...
const PHASE= {
  ...
  RESOURCE                         :   "", // CHAR (8) Work center SU3=AGR
  RESOURCE_TEXT                    :   "", // CHAR (40) Work center description
  SYSTEM_STATUS                    :   "", // CHAR (40) System Status
  SUPERIOR_OPERATION               :   "", // CHAR (4) ALPHA=NUMCV Superordinate Operation
  SECONDARY_RESOURCE               :   "", // CHAR (4) ALPHA=NUMCV Suboperation
  CONTROL_RECIPE_DESTINATION       :   "", // CHAR (2) Control Recipe Destination
};
