//
// BAPI_PROCORD_CHECK_MAT_AVAIL var: 4  struct: 1  table: 3  exception: 0
//
...
// FIX_PLANNED_ORDERS :           "", // CHAR (1) Firm Planned Orders
// RESET_AVAIL_DATA   :           "", // CHAR (1) Reset Availability Data
// SCOPE_AVAIL        :           "", // CHAR (1) Execute availability check (session)
...
const result = await client.call("BAPI_PROCORD_CHECK_MAT_AVAIL", parameters);
