//
// BAPI_PROCORD_CHANGE var: 3  struct: 4  table: 0  exception: 0
//
...
ORDERDATA           :           {}, // BAPI_PI_ORDER_CHANGE Transfer Structure for Changing Process Orders
ORDERDATAX          :           {}, // BAPI_PI_ORDER_CHANGEX Transfer Structure for Changing Process Orders

// EXPORT PARAMETERS

// MASTER_DATA_READ :           "", // CHAR (1) Indicator: Master Data Read
// ORDER_TYPE       :           "", // CHAR (4) Order Category SU3=AAT
// ORDER_STATUS     :           {}, // BAPI_ORDER_STATUS Order Status Indicator
// RETURN           :           {}, // BAPIRET2 Return Parameters
};

const result = await client.call("BAPI_PROCORD_CHANGE", parameters);
...
const ORDERDATA= {
  ...
  GOODS_RECEPIENT                  :   "", // CHAR (12) Goods recipient
