//
// BAPI_PRODORD_GET_LIST var: 1  struct: 1  table: 13  exception: 0
//
...
// ORDER_NUMBER_RANGE  :           [], // BAPI_PP_ORDERRANGE BAPI Interface Structure for Ranges of the Production Orders
...
const result = await client.call("BAPI_PRODORD_GET_LIST", parameters);
...
// BAPI_PP_ORDERRANGE  BAPI Interface Structure for Ranges of the Production Orders
