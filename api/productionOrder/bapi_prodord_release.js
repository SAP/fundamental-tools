//
// BAPI_PRODORD_RELEASE var: 3  struct: 1  table: 3  exception: 0
//
...
RELEASE_CONTROL       :           "", // CHAR (1) Release control order
...
const result = await client.call("BAPI_PRODORD_RELEASE", parameters);
