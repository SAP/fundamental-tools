//
// BAPI_PRODORD_CREATE var: 2  struct: 2  table: 0  exception: 0
//
...
ORDERDATA       :           {}, // BAPI_PP_ORDER_CREATE Transfer Structure for Creating Production Orders

// EXPORT PARAMETERS

// ORDER_NUMBER :           "", // CHAR (12) ALPHA=ALPHA Production order number SU3=ANR
// ORDER_TYPE   :           "", // CHAR (4) Order Type SU3=AAT
// RETURN       :           {}, // BAPIRET2 Return Parameters
};

const result = await client.call("BAPI_PRODORD_CREATE", parameters);
