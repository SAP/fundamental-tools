//
// BAPI_PERSDATA_SIMULATECREATION var: 43  struct: 1  table: 0  exception: 0
//
...
// NAME_FORMAT_INDICATOR :           "", // NUMC (2) Name format indicator for employee in a list
...
const result = await client.call("BAPI_PERSDATA_SIMULATECREATION", parameters);
