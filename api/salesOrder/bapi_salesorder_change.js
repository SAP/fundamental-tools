//
// BAPI_SALESORDER_CHANGE var: 5  struct: 3  table: 21  exception: 0
//
...
SALESDOCUMENT            :           "", // CHAR (10) ALPHA=ALPHA Order Number SU3=AUN
ORDER_HEADER_INX         :           {}, // BAPISDH1X Sales Order Check List
// BEHAVE_WHEN_ERROR     :        SPACE, // CHAR (1) Error Handling
// INT_NUMBER_ASSIGNMENT :        SPACE, // CHAR (1) Internal Item Number Assignment
// NO_STATUS_BUF_INIT    :        SPACE, // CHAR (1) No Refresh of Status Buffer
// SIMULATION            :           "", // CHAR (1) Simulation Mode
// LOGIC_SWITCH          :           {}, // BAPISDLS SD Checkbox for the Logic Switch
// ORDER_HEADER_IN       :           {}, // BAPISDH1 Order Header
...
// ORDER_ITEM_IN         :           [], // BAPISDITM Order Items
// ORDER_ITEM_INX        :           [], // BAPISDITMX Sales Order Items Check Table
...
const result = await client.call("BAPI_SALESORDER_CHANGE", parameters);

//
// IMPORT PARAMETERS
//

// BAPISDH1X  Sales Order Check List
...
const ORDER_HEADER_IN= {
  ...
  EXRATE_FI                        :  "0", // DEC (9.5) ALPHA=EXCRT Exchange rate for FI postings
  ...
  EXCHG_RATE                       :  "0", // DEC (9.5) ALPHA=EXCRT Exchange Rate for Price Determination
...
// prettier-ignore
const PARTNERCHANGES= {
  DOCUMENT                         :   "", // CHAR (10) ALPHA=ALPHA Sales and Distribution Document Number SU3=AUN
  ITM_NUMBER                       :   "", // NUMC (6) Item number of the SD document
  UPDATEFLAG                       :   "", // CHAR (1) Update indicator
  PARTN_ROLE                       :   "", // CHAR (2) ALPHA=PARVW Partner Function SU3=PAR
  P_NUMB_OLD                       :   "", // CHAR (10) ALPHA=ALPHA Partner number (KUNNR, LIFNR, or PERNR)
  P_NUMB_NEW                       :   "", // CHAR (10) ALPHA=ALPHA Partner number (KUNNR, LIFNR, or PERNR)
  ADDRESS                          :   "", // CHAR (10) ALPHA=ALPHA Address
...
// BAPISCHDLX  Check Table for Schedule Lines
const SCHEDULE_LINESX= [];
