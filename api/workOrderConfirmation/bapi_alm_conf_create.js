//
// BAPI_ALM_CONF_CREATE var: 2  struct: 1  table: 2  exception: 0
//
...
// POST_WRONG_ENTRIES :          '0', // CHAR (1) Ind.: Incorrect data in error pool
// TESTRUN            :           "", // CHAR (1) Test is active

// TABLE PARAMETERS

TIMETICKETS           :           [], // BAPI_ALM_TIMECONFIRMATION Table of confirmations
// DETAIL_RETURN      :           [], // BAPI_ALM_RETURN Return parameter for confirmation table
...
const result = await client.call("BAPI_ALM_CONF_CREATE", parameters);
...
// BAPI_ALM_TIMECONFIRMATION  Table of confirmations
const TIMETICKETS= [];
...
// BAPI_ALM_RETURN  Return parameter for confirmation table
const DETAIL_RETURN= [];
