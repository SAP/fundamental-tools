//
// BAPI_SERVICE_CHANGE var: 2  struct: 4  table: 5  exception: 0
//
...
SERVICENUMBER          :           "", // CHAR (18) ALPHA=ALPHA Service Number SU3=ASN
...
SERVICE_DESCRIPTION    :           [], // BAPISRV_ASMDT Short Texts for Service
// EXTENSION_IN        :           [], // BAPIPAREX Customer's Own Fields (Import Parameters)
// EXTENSION_OUT       :           [], // BAPIPAREX Customer's Own Fields (Export Parameters)
// SERVICE_LONG_TEXTS  :           [], // BAPISRV_TEXT Long Texts for Service
...
const result = await client.call("BAPI_SERVICE_CHANGE", parameters);
...
// BAPISRV_ASMDT  Short Texts for Service
...
// BAPISRV_TEXT  Long Texts for Service
