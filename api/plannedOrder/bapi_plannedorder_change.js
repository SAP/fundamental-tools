...
HEADERDATA             :           {}, // BAPIPLAF_I2 Header data (from external system)
HEADERDATAX            :           {}, // BAPIPLAF_I2X Change header data indicator fields
...
// CHANGEDHEADERDATA   :           {}, // BAPIPLAF_E1 Header Data (from SAP for External System)
// RETURN              :           {}, // BAPIRETURN1 Confirmations
};

const result = await client.call("BAPI_PLANNEDORDER_CHANGE", parameters);

//
// IMPORT PARAMETERS
//

// BAPIPLAF_I2  Header data (from external system)
...
const HEADERDATA= {
  ...
  INT_PROJECT_NUM                  :   "", // NUMC (8) ALPHA=ABPSP WBS Element
  ...
  DET_SCHEDULE                     :   "", // CHAR (1) Lead time scheduling (detailed planning)
  USE_COLL_UPD                     :   "", // CHAR (1) BAPI: Collective Update of Planning File Entries
...
// BAPIPLAF_I2X  Change header data indicator fields

// prettier-ignore
const HEADERDATAX= {
  PROD_PLANT                       :   "", // CHAR (1) Updated information in related user data field
  TOTAL_PLORD_QTY                  :   "", // CHAR (1) Updated information in related user data field
  FIXED_SCRAP_QTY                  :   "", // CHAR (1) Updated information in related user data field
  ORDER_START_DATE                 :   "", // CHAR (1) Updated information in related user data field
  ORDER_FIN_DATE                   :   "", // CHAR (1) Updated information in related user data field
  PLAN_OPEN_DATE                   :   "", // CHAR (1) Updated information in related user data field
  GR_PROC_TIME                     :   "", // CHAR (1) Updated information in related user data field
  CONVERSION_IND                   :   "", // CHAR (1) Updated information in related user data field
  FIRMING_IND                      :   "", // CHAR (1) Updated information in related user data field
  BOM_EXP_FIX_IND                  :   "", // CHAR (1) Updated information in related user data field
  ...
  INT_PROJECT_NUM                  :   "", // CHAR (1) Updated information in related user data field
  AGREEMENT                        :   "", // CHAR (1) Updated information in related user data field
  FIXED_VEND                       :   "", // CHAR (1) Updated information in related user data field
  ...
  DET_SCHEDULE                     :   "", // CHAR (1) Updated information in related user data field
...
// BAPIPLAF_E1  Header Data (from SAP for External System)

// prettier-ignore
const CHANGEDHEADERDATA= {
