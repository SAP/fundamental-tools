//
// BAPI_PLANNEDORDER_CREATE var: 1  struct: 6  table: 5  exception: 0
//
...
const result = await client.call("BAPI_PLANNEDORDER_CREATE", parameters);

//
// IMPORT PARAMETERS
//

// BAPIPLAF_I1  Header data (from external system)

// prettier-ignore
const HEADERDATA= {
  PLANNEDORDER_NUM                 :   "", // CHAR (10) ALPHA=ALPHA Planned order number SU3=PAF
  PLDORD_PROFILE                   :   "", // CHAR (4) Planned order profile SU3=PASCH
  ...
  MANUAL_COMPONENT                 :   "", // CHAR (1) Processing Indicator for BAPI Call
...
// BAPI_PLDORDCOMP_I1  Component data - create
...
const COMPONENTSDATA= {
  ...
  FIXED_QTY                        :   "", // CHAR (1) Quantity is fixed
...
// BAPI_PLDORDCOMP_E1  Created component data
const CREATEDCOMPONENTSDATA= [];
...
// BAPIPLAF_E1  Header Data (from SAP for the Ext. System)

// prettier-ignore
const CREATEDHEADERDATA= {
  PLANNEDORDER_NUM                 :   "", // CHAR (10) ALPHA=ALPHA Planned order number SU3=PAF
